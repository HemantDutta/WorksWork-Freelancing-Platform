...
export const AdminForgotPassword = () => {
    ...
    function ForgotPassword(adminEmail) {
        axios.get(`http://localhost:3000/admin-forgot-password?adminEmail=${adminEmail}`)
            .then((res)=>{
                            ...
                            <div className="card-body p-5 shadow-5 text-center">
                                ...
                                <form>
                                    ...
                                    <div className="mt-4 pt-2">
                                        <span className={'text-dark'}>Want to login? <Link to={'/admin-login'}>Click Here!</Link></span>
                                    </div>
                                </form>
                            </div>
                        </div>
